...
(function ($, undefined) {
    ...
    function initTabsPanelPaddingTopLine(target) {
        ...
        if ($.isNumeric(opts.lineHeight) && opts.lineHeight > 0) {
            if (!$.array.contains(["top", "bottom", "left", "right"], position)) {
                position = "top";
            }
        ...
        if (opts.enableConextMenu) {
            ...
            var panel = t.tabs("getTab", index),
                ...
                m0 = {
                    ...
                    handler: function () {
                        t.tabs("jumpTab", index);
                    }
                },
                m1 = {
                    text: "显示 Option", iconCls: "icon-standard-application-form", disabled: opts.showOption ? false : true, children: [
                        { text: "选项卡组 Option", iconCls: "icon-standard-tab-go", handler: function () {
                            t.tabs("showOption");
                        } },
                        { text: "该选项卡 Option", iconCls: "icon-standard-tab", handler: function () {
            ...
            if (opts.enableJumpTabMenu) {
                $.array.merge(items, "-", m0);
            }
            if (opts.showOption) {
    ...
    function parseContextMenuMap(e, title, index, menus, tabs) {
        return $.array.map(menus, function (value) {
            ...
            ret.onclick = $.isFunction(value.onclick) ? function (e, item, menu) {
                value.onclick.call(this, e, title, index, tabs, item, menu);
            } : value.onclick;
            ret.handler = $.isFunction(value.handler) ? function (e, item, menu) {
                value.handler.call(this, e, title, index, tabs, item, menu);
            } : value.handler;
            if (ret.children && ret.children.length) {
                ret.children = parseContextMenuMap(e, title, index, ret.children, tabs);
            }
            return ret;
        });
    };
    ...
    function newTab(target, which) {
        ...
        var dialogOptions = $.extend({
            ...
            onApply: function (dia) {
                ...
                var i = 0;
                while (tabs.tabs("getTab", title = title + (i ? i : ""))) {
                    i++;
                }
    ...
    function moveTab(tabTarget, param) {
        if (!param || param.source == undefined || param.target == undefined || !param.point) {
            return;
        }
    ...
    function setTitle(target, param) {
        if (!param || !(param.which || $.isNumeric(param.which)) || !param.title) {
            return;
        }
    ...
    function refreshCurrentTab(target, iniframe) {
        ...
        if (!iniframe && currentTabs.length) {
            index = current.currentTabIndex();
            if (index > -1) {
                currentTabs.tabs("refresh", index);
            }
        } else {
            var jq = $.util.parent.$;
            current = jq($.util.currentFrame);
    ...
    $.fn.extend({
        ...
        refreshCurrentTab: function (iniframe) {
            return this.each(function () {
                refreshCurrentTab(this, iniframe);
            });
        }
    });
