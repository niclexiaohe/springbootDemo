...
(function ($) {
    ...
    function callbackFunc(callback, oldTheme, theme, thisArg) {
        ...
        var item1 = $.array.first($.easyui.theme.dataSource, function (val) {
                return val.path == oldTheme;
            }),
            item2 = $.array.first($.easyui.theme.dataSource, function (val) {
                return val.path == theme;
            });
        if (item1) {
            oldTheme = item1;
        }
