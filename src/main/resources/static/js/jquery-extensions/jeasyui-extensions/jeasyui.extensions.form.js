...
(function ($, undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if ($.isFunction(opts.success)) {
                    return opts.success.call(target, data);
                }
            },
            beforeSend: function () {
    ...
    function validate(target) {
        ...
        for (var i = 0; i < plugins.length; i++) {
            ...
            var r = t.find('.' + plugin + '-f');
            if (r.length && $.fn[plugin] && $.fn[plugin]["methods"]) {
                if ($.util.tryExec(function () {
                    return r[plugin]("isValid");
                }) === false) {
                    $.util.tryExec({
                        code: function () {
                            r[plugin]("focus");
    ...
    var methods = $.fn.form.extensions.methods = {
        ...
        enable: function (jq, withButton) {
            return jq.each(function () {
                setFormDisabled(this, false, withButton);
            });
        },
        ...
        disable: function (jq, withButton) {
            return jq.each(function () {
                setFormDisabled(this, true, withButton);
            });
        },
